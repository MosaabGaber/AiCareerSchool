      ...
      >
        ...
        <div className="w-full bg-[#f7f7f7] border border-gray-200 rounded-xl px-4 md:px-6 py-4 flex justify-between items-center mb-8 mt-20">
          ...
          <div className="flex items-center gap-3">
            <span className="text-gray-500 line-through text-sm">EGP 4,500</span>
            <span className="text-black font-bold text-lg">EGP 2,500</span>
          </div>
        </div>
                ...
                <div className="flex flex-col-reverse md:flex-row-reverse gap-8 items-start border-t border-gray-200 pt-8 mt-4">
                  ...
                  <div className="w-full md:w-[320px] shrink-0 bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                    ...
                    <div className="border-t border-gray-200 pt-4 flex justify-between items-center mt-auto">
                      ...
                      <span className="text-[#1a9a46] font-bold text-xl">EGP 2,500</span>
                    </div>
                  </div>
                        ...
                        {paymentMethod === 'instapay' && (
                          <div className="sm:hidden bg-white rounded-xl border-2 border-gray-200 p-6 mt-4 shadow-sm animate-in fade-in slide-in-from-top-2 duration-300">
                            <p className="text-black font-semibold text-sm mb-1 text-right" dir="rtl">
                              ادفع 2,500 جنيه عن طريق InstaPay على <a href="https://ipn.eg/S/mosaabgaber2/instapay/6i3fZF" target="_blank" rel="noopener noreferrer" className="text-[#1a9a46] underline" dir="ltr" style={{ display: 'inline-block' }}>@mosaabgaber2</a>
                            </p>
                            <p className="text-gray-600 text-sm mb-4 text-left">
                              Pay EGP 2,500 via InstaPay to <a href="https://ipn.eg/S/mosaabgaber2/instapay/6i3fZF" target="_blank" rel="noopener noreferrer" className="text-[#1a9a46] font-semibold underline">@mosaabgaber2</a>
                            </p>
                            ...
                            <div className="mt-4 border-t border-gray-200 pt-4">
                              {!uploadSuccess ? (
                                ...
                                <div className="flex flex-col items-center gap-2 py-4">
                                  ...
                                  <a
                                    href="https://wa.me/201065716446?text=انا اشتركت في كورس العقارات و رفعت صورة التحويل"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="bg-[#25D366] text-white rounded-xl w-full py-3 font-bold text-sm flex items-center justify-center gap-2 mt-2"
                                  >
                                    ...
                                    انا اشتركت، تواصل معانا على الواتساب 💬
                                  </a>
                                </div>
                              )}
                            </div>
