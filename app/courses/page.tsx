...
export default function CoursesPage() {
  ...
  return (
    <main className="min-h-screen bg-white flex flex-col items-center pb-20 pt-24 px-4 md:px-8 relative z-10 selection:bg-blue-600 selection:text-white">
      ...
      {/* Header Section */}
      <div className="w-full max-w-6xl mx-auto text-center mb-10 flex flex-col items-center mt-2">
      ...
      {/* Search and Filters */}
      <div className="w-full max-w-[1000px] mx-auto mb-10 flex flex-col gap-6" dir="rtl">
        {/* Breadcrumb */}
